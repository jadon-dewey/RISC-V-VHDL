...
architecture RV32I of CPU_STAGE_ID is
    ...
    signal mret_control : std_logic := '0'; -- added signal declaration for PC context saving after interrupt handling
...
begin
    ...
    -- New process explicitly decoding mret instruction
    ...
    -- Pass mret_control forward explicitly
    signals_ex.mret <= mret_control; -- Added signal assignment
