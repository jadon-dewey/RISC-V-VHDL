...
entity MODULE_CONTROL_UNIT is
    ...
    port (
        ...
        mret        : out std_logic  -- New port for mret generation
    );
...
begin
    ...
    -- New mret decode:
    -- Assuming mret is a SYSTEM instruction with immediate bits [31:20] equal to "001100000010".
    is_mret <= '1' when (opcode = WORK.RV32I.OPCODE_SYSTEM and instruction(31 downto 20) = "001100000010") else '0';
