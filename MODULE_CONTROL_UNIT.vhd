...
begin
    ...
    control_ex.select_function <= "11" & funct3 when (is_mul OR is_mulh OR is_mulhsu OR is_mulhu) else
                                  '0'  & funct3; -- Default case for non-MUL operations
    ...
    control_wb.enable_destination <= '1' when (opcode = WORK.RV32I.OPCODE_OP or opcode = WORK.RV32I.OPCODE_OP_IMM or is_mul or is_mulh or is_mulhsu or is_mulhu) else '0';
